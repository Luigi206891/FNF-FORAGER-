...
class PlayState extends MusicBeatState
{
	...
	function leCoolSongName(durationIn:Float = 1, durationOut:Float = 1){
		...
		{
				FlxTween.tween(leSongName, {x: -200}, durationIn, {type:PERSIST, ease:FlxEase.backInOut});
				FlxTween.tween(leBox, {x: -550}, durationIn, {type:PERSIST, ease:FlxEase.backInOut});
		});
	}
